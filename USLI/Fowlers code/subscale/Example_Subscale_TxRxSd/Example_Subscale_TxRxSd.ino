/*
   ...
   Adds code to perform basic SD functions
...
// SD variables
unsigned int fileTimer = 0;
unsigned int fileInterval = 2000;
...
void loop()
{
  if(millis() == fileTimer + fileInterval)  // if the file write interval has passed
  {
    ...
    {
      Serial.println("error opening test.txt");  // error if file didn't open
    }
  }
